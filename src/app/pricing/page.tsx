                                ...
                                <div className="flex h-20 items-center justify-center border-b border-t border-gray-200 bg-gray-50">
                                  <div className="flex items-center space-x-1">
                                    ...
                                    <Tooltip delayDuration={300}>
                                      ...
                                      <TooltipContent className="w-80 p-2">How many PDFs you upload per month.</TooltipContent>
                                    </Tooltip>
                                  </div>
                                </div>
                                    ...
                                    return( 
                                      <li key={text} className='flex space-x-5'>
                                        <div className='flex-shrink-0'>
                                          {negative ? (<Minus className='h-6 w-6 text-grow-300'/>) : (<Check className='h-6 w-6 text-blue-300'/>)}
                                        </div>
                                        {footnote ? (
                                          <div className='flex items-center space-x-1'>
                                            <p className={cn("text-gray-400" , {"text-gray-600" : negative})}>{text}</p>
                                            <Tooltip delayDuration={300}>
                                              <TooltipTrigger className='cursor-default ml-1.5'>
                                                <HelpCircle className='h-4 w-4 text-zinc-500'></HelpCircle>
                                              </TooltipTrigger>
