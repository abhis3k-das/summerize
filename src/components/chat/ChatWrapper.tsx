  ...
  if(data?.status === 'FAILED'){
    ...
    <div className="flex-1 flex justify-center items-center flex-col mb-28">
      <div className="flex flex-col items-center gap-2">
        ...
        <p className='text-zinc-500 text-sm'>Your <span className='font-md'>Free</span> plan supports upto 5 pages per PDF.</p>
      </div>
    </div>
    <Link href='/href' className={buttonVariants({variant : "secondary" , className : 'mt-4'})}><ChevronLeft className='h-3 w-3 mr-1.5'/>Back</Link>
  </div>
  }
